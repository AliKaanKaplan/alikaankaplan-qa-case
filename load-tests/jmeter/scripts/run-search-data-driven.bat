...
echo ==========================================
echo Running JMeter data-driven search test...
echo ==========================================
...
set TEST_PLAN=%~dp0..\test-plans\search_data_driven.jmx
set RESULT_FILE=%~dp0..\results\jtl\search_data_driven_%TIMESTAMP%.jtl
set REPORT_DIR=%~dp0..\results\reports\search_data_driven_%TIMESTAMP%
set LOG_FILE=%~dp0..\logs\jmeter_data_driven_%TIMESTAMP%.log
